...
# Ensure the assignment root is importable so `fleet_game` imports work in tests.
...
def data_loader(data_dir: Path):
    ...
    from fleet_game.utils import DataLoader
...
def simple_map():
    ...
    from fleet_game.models import DeliveryMap
...
def sample_vehicle_type():
    ...
    from fleet_game.models import VehicleType
...
def sample_vehicle(sample_vehicle_type):
    ...
    from fleet_game.models import Vehicle
